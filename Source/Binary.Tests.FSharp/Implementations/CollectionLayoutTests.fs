...
let ``Converter Implementations And Null Or Empty Collection Binary Layout (integration test)`` () =
    ...
    test "ArrayLikeAdaptedConverter`2" "ArrayLikeNativeEndianAdapter`1" "ReadOnlyMemoryBuilder`1" (ReadOnlyMemory<int>())
    testNull "ArrayLikeAdaptedConverter`2" "ArrayLikeNativeEndianAdapter`1" "ArrayBuilder`1" (Array.zeroCreate<int> 0)
    ...
    testNull<Queue<_>> "CollectionAdaptedConverter`3" "EnumerableAdapter`2" "DelegateEnumerableBuilder`2" (Queue<int> 0)
    ...
    testNull<SortedList<_, _>> "CollectionAdaptedConverter`3" "DictionaryAdapter`3" "DelegateEnumerableBuilder`2" (SortedList<string, int>())
    testNull<SortedDictionary<_, _>> "CollectionAdaptedConverter`3" "DictionaryAdapter`3" "DelegateEnumerableBuilder`2" (SortedDictionary<TimeSpan, DateTime>())
    ()
