...
namespace Mikodev.Binary.Creators.ValueTuples
{
    internal sealed class ValueTupleConverter<T1, T2, T3, T4, T5, T6> : Converter<ValueTuple<T1, T2, T3, T4, T5, T6>>
    {
        ...
        public ValueTupleConverter(Converter<T1> convert1, Converter<T2> convert2, Converter<T3> convert3, Converter<T4> convert4, Converter<T5> convert5, Converter<T6> convert6)
