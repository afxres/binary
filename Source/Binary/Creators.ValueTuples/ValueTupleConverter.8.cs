...
{
    internal sealed class ValueTupleConverter<T1, T2, T3, T4, T5, T6, T7, TR> : Converter<ValueTuple<T1, T2, T3, T4, T5, T6, T7, TR>> where TR : struct
    {
        ...
        public ValueTupleConverter(Converter<T1> converter1, Converter<T2> converter2, Converter<T3> converter3, Converter<T4> converter4, Converter<T5> converter5, Converter<T6> converter6, Converter<T7> converter7, Converter<TR> converterR)
            : base(Define.GetConverterLength(converter1, converter2, converter3, converter4, converter5, converter6, converter7, converterR))
        {
        ...
        public override void ToBytes(ref Allocator allocator, ValueTuple<T1, T2, T3, T4, T5, T6, T7, TR> item)
        {
        ...
        public override void ToBytesWithMark(ref Allocator allocator, ValueTuple<T1, T2, T3, T4, T5, T6, T7, TR> item)
        {
            converter1.ToBytesWithMark(ref allocator, item.Item1);
            converter2.ToBytesWithMark(ref allocator, item.Item2);
            converter3.ToBytesWithMark(ref allocator, item.Item3);
        ...
        public override ValueTuple<T1, T2, T3, T4, T5, T6, T7, TR> ToValue(in ReadOnlySpan<byte> span)
        {
            var temp = span;
            ...
            return new ValueTuple<T1, T2, T3, T4, T5, T6, T7, TR>(item1, item2, item3, item4, item5, item6, item7, itemR);
        }

        public override ValueTuple<T1, T2, T3, T4, T5, T6, T7, TR> ToValueWithMark(ref ReadOnlySpan<byte> span)
        {
