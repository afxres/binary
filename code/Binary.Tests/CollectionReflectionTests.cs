...
namespace Mikodev.Binary.Tests
{
    public class CollectionReflectionTests
    {
        ...
        {
            var method = typeof(IConverter).Assembly.GetTypes().Single(x => x.Name is "FallbackSequentialMethods").GetMethod("CreateListBuilder", BindingFlags.Static | BindingFlags.NonPublic);
