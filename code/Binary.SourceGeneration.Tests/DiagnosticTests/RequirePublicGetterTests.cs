...
public class RequirePublicGetterTests
{
    ...
    [Theory(DisplayName = "Public Getter Required")]
    ...
    public void RequirePublicGetter(string source, string memberName, string typeName)
    {
        ...
        Assert.EndsWith($"A public getter is required, member name: {memberName}, containing type: {typeName}", diagnostic.ToString());
