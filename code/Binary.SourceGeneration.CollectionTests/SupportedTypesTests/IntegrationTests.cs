...
public class IntegrationTests
{
    ...
    {
        yield return [new List<int> { 1 }, 1, "ListNativeEndianConverter`1.*Int32"];
        ...
        yield return [ImmutableArray.Create(1), 1, "ArrayBasedNativeEndianConverter`3.*ImmutableArrayAdapter`1.*Int32"];
