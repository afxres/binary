...
public class MultidimensionalArrayUnsafeConverterTests
{
    ...
    {
        var generator = Generator.CreateDefaultBuilder().AddConverterCreator(new MultidimensionalArrayUnsafeConverterCreator()).Build();
        var converter = generator.GetConverter<T[,]>();
        Assert.Equal(typeof(MultidimensionalArrayUnsafeConverter<T[,], T>), converter.GetType());
